import styles from "./chart-list2.module.css"
...
export default function ChartList2({ mode, charts, setChartIndex }) {
    ...
    return <div className={styles["chart-list2"]}>
        {newCharts.map((chart, i) => (
            <div className={styles["chart-item2"]} key={i} onClick={(event) => {
